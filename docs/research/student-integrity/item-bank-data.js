...
window.STUDENT_ITEM_BANK = [
  {
    ...
    "safetyMode": "standard",
    "title": "과제와 생성형 AI",
    "scenario": "수행평가 초안을 만들 시간이 부족합니다. 생성형 AI가 만든 글에는 확인하지 못한 출처도 있지만 문장은 자연스럽습니다.",
    "decisionPrompt": "나라면 제출 전에 어떻게 할까요?",
    "choices": [
      {
        "id": "submit-directly",
        "text": "시간이 없으므로 거의 그대로 제출한다"
      },
      {
        "id": "verify-disclose",
        "text": "내용과 출처를 확인하고 AI 사용 부분을 밝힌다"
      },
      {
        "id": "rewrite-only",
        "text": "문장만 내 말투로 바꾸고 사용 여부는 쓰지 않는다"
      },
      {
        "id": "ask-standard",
        "text": "선생님에게 허용 범위와 표시 방법을 확인한다"
      }
    ],
  ...
  },
  {
    ...
    "decisionPrompt": "나라면 먼저 어떻게 할까요?",
    "choices": [
      {
        "id": "send-file",
        "text": "친구를 믿고 파일을 보내 준다"
      },
      {
        "id": "explain-only",
        "text": "풀이 과정이나 자료 찾는 방법만 설명한다"
      },
      {
        "id": "work-together",
        "text": "남은 시간 동안 각자 작성하도록 함께 정리한다"
      },
      {
        "id": "ask-teacher",
        "text": "제출이 늦어질 수 있음을 선생님께 함께 알린다"
      }
    ],
    "reasonPrompt": "그 행동을 고른 이유와 가장 가까운 것은 무엇인가요?",
    "reasons": [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "ask-permission",
        "text": "사진 속 학생에게 공유해도 되는지 먼저 물어보자고 한다"
      },
      {
        "id": "share-limited",
        "text": "우리 반 대화방 안에서만 보는 조건으로 올린다"
      },
      {
        "id": "remove-face",
        "text": "얼굴을 가린 뒤 필요한 부분만 공유한다"
      },
      {
        "id": "seek-help",
        "text": "친구에게 바로 말하기 어렵다면 믿을 수 있는 어른에게 상황을 알린다"
      }
    ],
    "reasonPrompt": "그 행동을 고른 이유와 가장 가까운 것은 무엇인가요?",
    "reasons": [
  ...
  },
  {
    ...
    "decisionPrompt": "나라면 어떻게 반응할까요?",
    "choices": [
      {
        "id": "stop-forwarding",
        "text": "확인되지 않은 내용은 더 전달하지 않는다"
      },
      {
        "id": "ask-source",
        "text": "처음 말한 사람이 누구인지 확인해 본다"
      },
      {
        "id": "tell-adult",
        "text": "상황이 커지기 전에 믿을 수 있는 어른에게 알린다"
      },
      {
        "id": "watch-only",
        "text": "공개적으로 나서면 상황이 커질까 걱정되어 반응을 지켜본다"
      }
    ],
    "reasonPrompt": "그 행동을 고른 이유와 가장 가까운 것은 무엇인가요?",
    "reasons": [
  ...
  },
  {
    ...
    "choices": [
      {
        "id": "contact-first",
        "text": "친구에게 상황을 확인하고 가능한 역할을 다시 정한다"
      },
      {
        "id": "group-decision",
        "text": "참여한 모둠원끼리 이름을 뺄지 바로 결정한다"
      },
      {
        "id": "teacher-check",
        "text": "사실관계를 정리해 선생님과 평가 기준을 확인한다"
      },
      {
        "id": "keep-as-is",
        "text": "갈등을 피하려고 원래대로 모두의 이름을 적는다"
      }
    ],
    "reasonPrompt": "그 행동을 고른 이유와 가장 가까운 것은 무엇인가요?",
    "reasons": [
  ...
  },
  {
    ...
    "safetyMode": "standard",
    "title": "학생회 행사의 물품 선택",
    "scenario": "학생회 행사 물품 후보를 살펴보던 중 한 임원의 가족이 운영하는 가게가 추천되었습니다. 가격은 조금 비싸지만 준비를 도와줄 수 있다고 합니다.",
    "decisionPrompt": "나라면 물품을 어떻게 정할까요?",
    "choices": [
      {
        "id": "compare-options",
        "text": "가격과 조건을 같은 기준으로 비교한 뒤 정한다"
      },
      {
        "id": "choose-senior",
        "text": "도움을 받을 수 있으므로 그 가게를 추천한다"
      },
      {
        "id": "share-relationship",
        "text": "관계를 먼저 알리고 다른 학생들과 함께 결정한다"
      },
      {
        "id": "avoid-conflict",
        "text": "오해를 피하려고 그 가게는 후보에서 제외한다"
      }
    ],
    "reasonPrompt": "그 행동을 고른 이유와 가장 가까운 것은 무엇인가요?",
    "reasons": [
  ...
  },
  {
    ...
    "decisionPrompt": "나라면 수정 내용을 어떻게 처리할까요?",
    "choices": [
      {
        "id": "explain-change",
        "text": "바꾼 이유와 수정한 부분을 문서에 남긴다"
      },
      {
        "id": "edit-directly",
        "text": "결과가 더 좋아졌으므로 그대로 제출한다"
      },
      {
        "id": "restore-original",
        "text": "갈등을 피하려고 친구가 쓴 내용으로 되돌린다"
      },
      {
        "id": "ask-group",
        "text": "핵심 변경만 모둠원에게 확인받고 제출한다"
      }
    ],
    "reasonPrompt": "그 행동을 고른 이유와 가장 가까운 것은 무엇인가요?",
    "reasons": [
  ...
  },
  {
    ...
    "decisionPrompt": "나라면 어떻게 할까요?",
    "choices": [
      {
        "id": "borrow-account",
        "text": "친구가 허락했으므로 잠깐 로그인한다"
      },
      {
        "id": "use-together",
        "text": "친구 기기에서 친구와 함께 필요한 자료만 확인한다"
      },
      {
        "id": "request-help",
      ...
      {
        "id": "wait-later",
        "text": "지금은 포기하고 내 계정이 될 때까지 기다린다"
      }
    ],
    "reasonPrompt": "그 행동을 고른 이유와 가장 가까운 것은 무엇인가요?",
    "reasons": [
  ...
  },
  {
    ...
    "safetyMode": "help-seeking",
    "title": "이유를 알기 어려운 규칙",
    "scenario": "학급에서 새 규칙이 정해졌지만 왜 필요한지 설명을 듣지 못했습니다. 몇몇 학생에게만 예외가 적용되는 것처럼 보입니다.",
    "decisionPrompt": "나라면 먼저 어떻게 할까요?",
    "choices": [
      {
        "id": "ask-reason",
        "text": "규칙의 목적과 예외 기준을 차분히 질문한다"
      },
      {
        "id": "follow-only",
        "text": "정해진 규칙이므로 이유를 몰라도 따른다"
      },
      {
        "id": "seek-support",
        "text": "혼자 말하기 어렵다면 믿을 수 있는 어른이나 학생 대표에게 도움을 요청한다"
      },
      {
        "id": "collect-views",
        "text": "친구들 의견을 정리해 공식적으로 건의한다"
      }
    ],
    "reasonPrompt": "그 행동을 고른 이유와 가장 가까운 것은 무엇인가요?",
    "reasons": [
  ...
  },
  {
    ...
    "safetyMode": "standard",
    "title": "공동 물품의 개인 사용",
    "scenario": "동아리에서 함께 구입한 물품이 주말 동안 비어 있습니다. 개인 활동에 잠깐 쓰고 바로 돌려놓으면 다른 사람은 모를 것 같습니다.",
    "decisionPrompt": "나라면 어떻게 할까요?",
    "choices": [
      {
        "id": "ask-first",
        "text": "사용 목적과 기간을 알리고 먼저 허락을 받는다"
      },
      {
        "id": "use-return",
        "text": "손상되지 않게 사용하고 바로 돌려놓는다"
      },
      {
        "id": "do-not-use",
        "text": "공동 물품이므로 개인적으로는 사용하지 않는다"
      },
      {
        "id": "make-rule",
        "text": "이번 기회에 개인 사용 기준을 함께 정하자고 제안한다"
      }
    ],
    "reasonPrompt": "그 행동을 고른 이유와 가장 가까운 것은 무엇인가요?",
    "reasons": [
  ...
  },
  {
    ...
    "decisionPrompt": "나라면 확인서를 어떻게 할까요?",
    "choices": [
      {
        "id": "submit-given",
        "text": "담당자가 괜찮다고 했으므로 그대로 제출한다"
      },
      {
        "id": "ask-correction",
        "text": "실제 활동 시간으로 고쳐 달라고 요청한다"
      },
      {
        "id": "explain-school",
        "text": "학교에 상황을 설명하고 처리 기준을 확인한다"
      },
      {
        "id": "skip-submission",
        "text": "문제가 생길 수 있으므로 확인서를 제출하지 않는다"
      }
    ],
    "reasonPrompt": "그 행동을 고른 이유와 가장 가까운 것은 무엇인가요?",
    "reasons": [
  ...
  },
  {
    ...
    "decisionPrompt": "나라면 먼저 무엇을 제안할까요?",
    "choices": [
      {
        "id": "workers-snack",
        "text": "준비한 학생들의 수고를 고려해 간식을 산다"
      },
      {
        "id": "class-use",
        "text": "학급 전체가 사용할 수 있는 곳에 쓴다"
      },
      {
        "id": "check-agreement",
        "text": "처음 정한 사용 목적과 참여자 동의를 확인한다"
      },
      {
        "id": "split-use",
        "text": "일부는 준비한 학생, 일부는 학급을 위해 나눠 쓴다"
      }
    ],
    "reasonPrompt": "그 행동을 고른 이유와 가장 가까운 것은 무엇인가요?",
    "reasons": [
