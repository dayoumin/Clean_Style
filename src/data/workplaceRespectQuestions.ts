...
const resultContent: Record<RespectEntry, Record<RespectRiskLevel, Omit<RespectResult, 'entry' | 'level' | 'score' | 'crisis' | 'support' | 'answeredCount' | 'axisSummary'>>> = {
  action: {
    ...
    urgent: {
      title: '지금은 기준 확인이 먼저입니다',
      summary: '강한 압박이나 안전 우려로 보일 수 있는 답변입니다. 혼자 판단하기보다 잠시 멈추고 기관 기준과 제3자 확인을 함께 살피는 것이 좋습니다.',
      primaryActions: ['해당 말·연락·지시는 잠시 멈추고 상황을 먼저 정리하세요.', '혼자 판단하지 말고 인사·감사·인권 담당자에게 기준을 확인하세요.', '안전 우려가 있으면 가까운 책임자와 분리·보호 절차를 확인하세요.'],
      supportActions: ['기관의 갑질 예방 매뉴얼, 복무·인사 기준, 신고·상담 절차를 함께 확인하세요.'],
    },
  },
  experience: {
    low: {
    ...
    high: {
      title: '보호 조치 검토가 필요해요',
      summary: '여러 기준이 함께 나타납니다. 기록을 정리하고 내부 상담, 보호 조치, 신고 절차를 확인해 볼 단계입니다.',
      primaryActions: ['상황별 기록을 시간순으로 정리하세요.', '담당부서에 상담 가능 여부를 확인하세요.', '보복이나 2차 피해가 우려되면 보호 조치를 문의하세요.'],
      supportActions: ['마음건강 영향이 크다면 정신건강복지센터나 기관 상담창구도 확인하세요.'],
    },
    urgent: {
